...
/**
 * @Author Gangbb
 * @Description Entity实体对象 到 实际业务对象 的相互转换。实现类通常声明在Model实体类中。
 * @param <D> 业务对象对象类型。
 * @param <E> Entity实体对象类型。
 * @Date 2021/8/9
 **/
public interface BaseModelMapper<D, E> {
     ...
     * @return Domain域对象列表。
     */
    List<D> fromModelList(List<E> modelList);
     ...
     * @return Model实体对象列表。
     */
    List<E> toModelList(List<D> domainList);
